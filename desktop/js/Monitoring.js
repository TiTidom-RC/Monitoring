...
function addCmdToTable(_cmd) {
	...
	if (_cmd.logicalId == 'loadavg1mn' || _cmd.logicalId == 'loadavg5mn' || _cmd.logicalId == 'loadavg15mn' || _cmd.logicalId == 'cpu_temp' || _cmd.logicalId == 'hddpourcused' || _cmd.logicalId == 'hddpourcusedv2' || _cmd.logicalId == 'hddpourcusedusb') {
		tr += '<span style="color: green">MIN \< [Vert <input class="cmdAttr eqLogicAttr form-control" data-l1key="configuration" data-l2key="' + init(_cmd.logicalId) + '_colorlow" type="text" style="width: 60px;display: inherit" /> ]</span><span style="color: orange"> \< [Orange] \< </span><span style="color: red">[ <input class="cmdAttr eqLogicAttr form-control" data-l1key="configuration" data-l2key="' + init(_cmd.logicalId) + '_colorhigh" style="width: 60px;display: inherit" /> Rouge] \< MAX</span>';
	}
	if (_cmd.logicalId == 'Mempourc' || _cmd.logicalId == 'Swappourc') {
		tr += '<span style="color: red">MIN \< [Rouge <input class="cmdAttr eqLogicAttr form-control" data-l1key="configuration" data-l2key="' + init(_cmd.logicalId) + '_colorlow" type="text" style="width: 60px;display: inherit" /> ]</span><span style="color: orange"> \< [Orange] \< </span><span style="color: green">[ <input class="cmdAttr eqLogicAttr form-control" data-l1key="configuration" data-l2key="' + init(_cmd.logicalId) + '_colorhigh" style="width: 60px;display: inherit" /> Vert] < MAX</span>';
	}
	if (_cmd.logicalId == 'perso1' || _cmd.logicalId == 'perso2') {
        ...
        tr += '<br/><span style="color: green">MIN \< [Vert <input class="cmdAttr eqLogicAttr form-control" data-l1key="configuration" data-l2key="' + init(_cmd.logicalId) + '_colorlow" type="text" style="width: 60px;display: inherit" /> ]</span><span style="color: orange"> \< [Orange] \< </span><span style="color: red">[ <input class="cmdAttr eqLogicAttr form-control" data-l1key="configuration" data-l2key="' + init(_cmd.logicalId) + '_colorhigh" style="width: 60px;display: inherit" /> Rouge] \< MAX</span>';
	}
	tr += '</td>';
