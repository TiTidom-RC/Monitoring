...
function addCmdToTable(_cmd) {
	...
	if (_cmd.logicalId == 'perso1' || _cmd.logicalId == 'perso2') {
		...
		tr += '<span class="cmdAttr input-group-addon roundedRight" data-l1key="display" data-l2key="icon" style="margin: 1px auto;font-size:19px;padding: 0 5px 0 0!important;"></span>';
		tr += '</div>';
	}
	else
	{
