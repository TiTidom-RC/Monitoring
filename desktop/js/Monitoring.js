...
function toggleSSHPassword() {
	...
	sshPasswordField.innerHTML = sshPasswordField.type === "password" ? "<i class=\"fas fa-eye-slash\"></i>" : "<i class=\"fas fa-eye-slash\"></i>";
...
function toggleSSHPassphrase() {
	...
	sshPassphraseField.innerHTML = sshPassphraseField.type === "password" ? "<i class=\"fas fa-eye-slash\"></i>" : "<i class=\"fas fa-eye-slash\"></i>";
