...
function addCmdToTable(_cmd) {
	...
	if (_cmd.logicalId == 'loadavg1mn' || _cmd.logicalId == 'loadavg5mn' || _cmd.logicalId == 'loadavg15mn' || _cmd.logicalId == 'cpu_temp' || _cmd.logicalId == 'hddpourcused' || _cmd.logicalId == 'hddpourcusedv2' || _cmd.logicalId == 'hddpourcusedusb') {
		tr += '<span style="color: green">[Vert] \< <input class="cmdAttr eqLogicAttr form-control" data-l1key="configuration" data-l2key="' + init(_cmd.logicalId) + '_colorlow" type="text" style="margin: 5px auto;width: 60px;display: inherit" /></span><span style="color: orange"> \u{2264} [Orange] \u{2264} </span><span style="color: red"><input class="cmdAttr eqLogicAttr form-control" data-l1key="configuration" data-l2key="' + init(_cmd.logicalId) + '_colorhigh" style="margin: 5px auto;width: 60px;display: inherit" /> \< [Rouge]</span>';
	}
	if (_cmd.logicalId == 'Mempourc' || _cmd.logicalId == 'Swappourc') {
		tr += '<span style="color: red">[Rouge] \< <input class="cmdAttr eqLogicAttr form-control" data-l1key="configuration" data-l2key="' + init(_cmd.logicalId) + '_colorlow" type="text" style="margin: 5px auto;width: 60px;display: inherit" /></span><span style="color: orange"> \u{2264} [Orange] \u{2264} </span><span style="color: green"><input class="cmdAttr eqLogicAttr form-control" data-l1key="configuration" data-l2key="' + init(_cmd.logicalId) + '_colorhigh" style="margin: 5px auto;width: 60px;display: inherit" /> \< [Vert]</span>';
	}
	if (_cmd.logicalId == 'perso1' || _cmd.logicalId == 'perso2') {
