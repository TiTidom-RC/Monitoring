...
function addCmdToTable(_cmd) {
	...
	if (_cmd.logicalId == 'perso1' || _cmd.logicalId == 'perso2') {
		...
		tr += '<span class="cmdAttr input-group-addon roundedRight" data-l1key="display" data-l2key="icon" style="margin: 1px auto;font-size:18px;padding: 1px 5px 0 1px!important;"></span>';
		tr += '</div>';
	}
	else
	{
