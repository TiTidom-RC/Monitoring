                            ...
                            <fieldset>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-8">
                                        ...
                                        <span style="font-size: 85%;">({{à cocher si vous désirez monitorer un NAS Synology}})</span>
                                    </div>
                                </div>
                                <div class="syno_conf">
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-8">
                                            ...
                                            <span style="font-size: 85%;">({{à cocher si le nom du modèle de votre Syno est mal détecté}})</span>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-8">
                                            ...
                                            <span style="font-size: 85%;">({{à cocher si vous avez un 2ème volume (Volume 2)}})</span>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-8">
                                            ...
                                            <span style="font-size: 85%;">({{à cocher si vous avez un volume USB}})</span>
                                        </div>
                                    </div>
                                    <div class="form-group">
