                            ...
                            <fieldset>
                                ...
                                <div class="form-group">
                                    <label class="col-md-4 control-label">{{Tempo Cmd}}
                                        <sup><i class="fas fa-question-circle tooltips" title="{{Délai / Pause en secondes entre chaque commande (Entre 0.0 et 2.0 sec par pas de 0.1, par défaut : 0)}}"></i></sup>
                                    </label>
                                    <div class="col-md-6">
...
<?php 
    if (class_exists('sshmanager')) {
        ...
        log::add('Monitoring', 'error', __('[PLUGIN] Impossible de charger le fichier sshmanager.helper.js (Vérifiez les dépendances)', __FILE__));
    }
?>
