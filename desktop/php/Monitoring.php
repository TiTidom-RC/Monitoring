					...
					<div class="col-sm-6">
                        <form class="form-horizontal">
                            <fieldset>
                                ...
                                <div class="form-group">
                                    <label class="col-md-4 control-label">{{Nb de Commandes 'Perso'}}
                                    ...
                                    <div class="col-md-1">
                                        <input class="eqLogicAttr form-control" type="number" data-l1key="configuration" data-l2key="nbCmdPerso"  min="2" max="50" placeholder="{{2}}" />
                                    </div>
                                </div>
                            </fieldset>
                        </form>
