...
class Monitoring extends eqLogic {
	...
	public function toHtml($_version = 'dashboard') {
		...
		$replace['#namedistri_display#'] = (is_object($namedistri) && $namedistri->getIsVisible()) ? "inherit" : "none";
		...
		$replace['#loadavg_display#'] = (is_object($loadavg1mn) && $loadavg1mn->getIsVisible()) ? "inherit" : "none";
		...
		$replace['#uptime_display#'] = (is_object($uptime) && $uptime->getIsVisible()) ? "inherit" : "none";
		...
		$replace['#Mem_display#'] = (is_object($Mem) && $Mem->getIsVisible()) ? "inherit" : "none";
		...
		$replace['#Mem_swap_display#'] = (is_object($Mem_swap) && $Mem_swap->getIsVisible()) ? "inherit" : "none";
		...
		$replace['#ethernet0_display#'] = (is_object($ethernet0) && $ethernet0->getIsVisible()) ? "inherit" : "none";
		...
		$replace['#hddused_display#'] = (is_object($hddtotal) && $hddtotal->getIsVisible()) ? "inherit" : "none";
		...
		$replace['#cpu_display#'] = (is_object($cpu) && $cpu->getIsVisible()) ? "inherit" : "none";
		...
		if($this->getConfiguration('synology') == '1' && $SynoV2Visible == 'OK' && $this->getConfiguration('synologyv2') == '1'){
			...
			$replace['#hddusedv2_display#'] = (is_object($hddtotalv2) && $hddtotalv2->getIsVisible()) ? "inherit" : "none";
		...
		if($this->getConfiguration('synology') == '1' && $SynoUSBVisible == 'OK' && $this->getConfiguration('synologyusb') == '1'){
			...
			$replace['#hddusedusb_display#'] = (is_object($hddtotalusb) && $hddtotalusb->getIsVisible()) ? "inherit" : "none";
		...
		if($this->getConfiguration('synology') == '1' && $SynoeSATAVisible == 'OK' && $this->getConfiguration('synologyesata') == '1'){
			...
			$replace['#hddusedesata_display#'] = (is_object($hddtotalesata) && $hddtotalesata->getIsVisible()) ? "inherit" : "none";
		...
		$replace['#cron_status_display#'] = (is_object($cron_status) && $cron_status->getIsVisible()) ? "inherit" : "none";
		...
		$replace['#perso1_display#'] = (is_object($perso1) && $perso1->getIsVisible()) ? "inherit" : "none";
		...
		$replace['#perso2_display#'] = (is_object($perso2) && $perso2->getIsVisible()) ? "inherit" : "none";
		...
		foreach ($this->getCmd('action') as $cmd) {
			...
			$replace['#cmd_' . $cmd->getLogicalId() . '_display#'] = (is_object($cmd) && $cmd->getIsVisible()) ? "inherit" : "none";
		}
